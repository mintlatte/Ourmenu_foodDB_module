...
public class FatSecretSearch {
    ...
    final static private String APP_KEY = "f8482ff568e9419eaae6d266e1e17f48";
    final static private String APP_SECRET = "58e91a77282c4cc597b64b0e9c2aca62";
    ...
    private static String sign(String method, String uri, String[] params) {
        ...
        String s = join(p, "&");
        String temp_app_key = APP_SECRET + "&";
        // SecretKey sk = new SecretKeySpec(APP_SECRET.getBytes(), HMAC_SHA1_ALGORITHM);
        SecretKey sk = new SecretKeySpec(temp_app_key.getBytes(), HMAC_SHA1_ALGORITHM);
        try {
